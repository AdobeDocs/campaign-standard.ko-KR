...
필터는 각 리소스에 대해 사용할 수 있습니다. 리소스에 연결된 필터를 식별하려면 리소스 메타데이터에 대해 GET 요청을 수행해야 합니다. 이 요청은 지정된 리소스에 대해 모든 필터가 정의된 URL을 반환합니다. 메타데이터에 대한 자세한 내용은 [이 섹션](../../api/using/metadata-mechanism.md)을 참조하십시오.
...
* [사용 사례:합성 식별 키를 사용하여 리소스 호출](https://docs.adobe.com/content/help/en/campaign-standard/using/developing/adding-or-extending-a-resource/uc-calling-resource-id-key.html).
