...
모든 API 리소스는 **JSON** URL 확장이나 HTTP Accept 헤더 내에서 다음을 수행합니다.

`GET /profileAndServices/<resourceName>.json`

>[!NOTE]
>
>URL에 확장이 없으면 **json 형식은 기본 형식입니다** 컨텐츠 유형에 사용할 수 있습니다.
...
에 사용자 지정 키 사용 **최상위 프로필 리소스** 전용. URL은 API에서 반환되며, 직접 빌드해서는 안 됩니다.
