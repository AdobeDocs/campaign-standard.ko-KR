---
title: 크로스 채널 게재
description: 이 사용 사례에서는 채널 간 게재를 만드는 방법을 보여 줍니다
audience: automating
...
1. 드래그 앤 드롭 [이메일 게재](../../automating/using/email-delivery.md) 첫 번째 세그먼트 이후의 활동.
...
1. 콘텐츠를 편집하고 저장합니다.
1. 다음에서 **[!UICONTROL Schedule]** 메시지 대시보드의 섹션에서 **[!UICONTROL Request confirmation before sending messages]** 옵션을 선택합니다.

SMS 게재를 만드는 방법:

1. 드래그 앤 드롭 [SMS 게재](../../automating/using/sms-delivery.md) 다른 세그먼트 다음에 활동을 추가합니다.
1. 활동을 두 번 클릭하여 편집합니다.
...
워크플로우가 시작되면 의 타겟이 되는 모집단입니다. **[!UICONTROL Query]** 활동은 세분화되어 이메일 또는 SMS 게재를 수신하게 됩니다.
