...
>[!NOTE]
>
>외부 매개 변수를 사용한 워크플로우를 호출한 후 이벤트 변수를 사용할 수 있도록 하는 모든 활동에서 추가 함수를 사용할 수 있습니다. 이 내용은 [이 섹션](../../automating/using/customizing-workflow-external-parameters.md)에 자세히 설명되어 있습니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 매개 변수로 전달된 두 문자열을 연결합니다. 반환된 값의 각 문자열 사이에 공백이 추가됩니다.<br /> </td> 
   <td> JuxtWords(&lt;문자열&gt;, &lt;문자열&gt;)<br /> </td> 
  </tr> 
  <tr> 
   <td> <strong>JuxtWords3</strong><br /> </td> 
   <td> 매개 변수로 전달된 세 개의 문자열을 연결합니다. 반환된 값의 각 문자열 사이에 공백이 추가됩니다.<br /> </td> 
