...
워크플로우 편집 화면은 다음과 같은 요소로 구성됩니다.

* 사용 가능한 [활동을 참조하는](#palette)팔레트.
* 활동이 [구성](#workspace)및 구성된 작업 공간입니다.
* 워크플로우 및/또는 [해당](#action-bar)구성 요소와 상호 작용할 수 있는 단추로 구성된 작업 막대가 표시됩니다.
* 선택한 활동 주위에 나타나는 [빠른 작업](#quick-actions)기능을 사용하면 해당 작업을 상호 작용할 수 있습니다.
...
워크플로우의 팔레트에서 활동을 사용하려면 작업 공간으로 드래그하여 놓습니다.
...
작업 영역은 워크플로우 편집기의 중앙 영역입니다. 이 영역에서는 활동을 삭제하고 전환을 사용하여 함께 연결하고 구성할 수 있습니다.

두 활동을 연결하려면 첫 번째 활동에서 다음 활동까지 화살표 끝을 이동합니다. 활동을 이전 활동에 연결하려면 뒤에 있는 화살표 지점으로 이동할 수도 있습니다. 활동을 이동하면 해당 활동이 계속 연결됩니다.

데이터를 처리하는 활동에 따른 전환에는 중간 모집단이 포함됩니다. 워크플로우 속성의 섹션 **[!UICONTROL Keep interim results]** 에서 옵션 **[!UICONTROL Execution]** 을 선택하면 액세스할 수 있습니다.
...
특정 기능은 작업 공간에서만 활성화됩니다.

* 여러 활동 및 전환 효과를 선택할 수 있습니다.
* 여러 활동 및/또는 전환 효과를 선택하려면 **Ctrl** + 마우스 왼쪽 버튼을 클릭합니다.
...
<img height="21px" src="assets/stop_darkgrey-24px_table.png" /> **[!UICONTROL Stop]**<br/>워크플로우 실행 중단 중단된 위치에서 다시 시작할 수 없습니다.
...
작업 영역을 사용하면 동일한 워크플로에 복사하여 붙여넣거나 동일한 캠페인 인스턴스의 다른 워크플로에 붙여넣어 워크플로우 활동을 복제할 수 있습니다.
...
1. 활동을 선택한 다음 빠른 작업 **[!UICONTROL Copy selection]** 에서 단추를 클릭합니다.
...
1. 대상 워크플로우 작업 영역에서 마우스 오른쪽 버튼을 클릭한 다음 **[!UICONTROL Paste]** 단추를 클릭합니다.
   ...
   또한 **Ctrl + V** 키보드 단축키를 사용할 수 있습니다.

   ![](assets/wkf_copypaste2.png)

1. 활동이 복제되며 처음에 구성된 모든 설정이 중복됩니다.

또한 여러 활성화 항목을 복사하여 전체 흐름을 복제할 수 있습니다.
