...
* 다음 [작업 영역](#workspace)(활동 구성 및 구성)
* 다음 [작업 표시줄](#action-bar)- 워크플로 및/또는 해당 구성 요소와 상호 작용할 수 있는 버튼으로 구성됩니다.
* 다음 [빠른 작업](#quick-actions)선택한 활동 주위에 표시되는 를 사용하여 해당 활동과 상호 작용할 수 있습니다.
...
* [타겟팅](../../automating/using/about-targeting-activities.md): 타겟팅, 모집단 데이터 조작 및 필터링 활동과 관련된 활동
...
데이터를 처리하는 다음 활동에는 중간 모집단이 포함됩니다. 다음을 확인하면 액세스할 수 있습니다. **[!UICONTROL Keep interim results]** 의 옵션 **[!UICONTROL Execution]** 워크플로 속성의 섹션입니다.
...
활동을 선택하면 활동 주위에 빠른 작업이 표시되어 활동을 상호 작용할 수 있습니다. 예를 들어 활동을 구성하려면 활동을 선택한 다음 를 사용하여 엽니다. ![](assets/edit_darkgrey-24px_table.png) 단추를 클릭합니다.

특정 기능은 작업 영역에서만 활성화됩니다.

* 여러 활동 및 전환 주위에 영역을 그려서 선택합니다.
* 누르기 **Ctrl** + 여러 활동 및/또는 전환을 선택하려면 마우스 왼쪽 단추를 클릭하십시오.
* 누르기 **입력** 현재 선택한 활동 또는 전환의 세부 정보를 봅니다.
* 누르기 **삭제** 현재 선택한 활동을 삭제합니다.
* 누르기 **Ctrl + C** 선택한 활동을 복사하려면 **Ctrl + V** 을 눌러 작업 영역에 붙여넣습니다.
...
<img height="21px" src="assets/pending_darkgrey-24px_table.png" /> **[!UICONTROL Immediate execution]**<br/>선택 항목을 강제로 즉시 처리합니다. 이 단추는 다음에만 사용할 수 있습니다. <span class="uicontrol">스케줄러</span> 및 <span class="uicontrol">대기</span> 활동.
...
1. 활동을 선택한 다음 **[!UICONTROL Copy selection]** 바로 가기의 단추입니다.

   다음을 사용할 수도 있습니다 **Ctrl + C** 키보드 단축키.

   ![](assets/wkf_copypaste1.png)

1. 대상 워크플로우 작업 영역을 마우스 오른쪽 단추로 클릭하고 **[!UICONTROL Paste]** 단추를 클릭합니다.

   다음을 사용할 수도 있습니다 **CTRL + V** 키보드 단축키.
...
이렇게 하려면 활동 주위에 영역을 그려서 활동을 선택합니다. 그런 다음 **[!UICONTROL Copy selection]** 작업 표시줄의 단추(또는 누르기) **Ctrl + C**). 그런 다음 원하는 위치에 붙여넣을 수 있습니다.
