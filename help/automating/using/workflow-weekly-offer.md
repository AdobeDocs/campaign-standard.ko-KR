...
1. **[!UICONTROL Activities]** > **[!UICONTROL Targeting]**&#x200B;에서 수신자를 선택하려면 [쿼리](../../automating/using/query.md) 활동을 끌어다 놓고 두 번 클릭합니다.
...
1. **[!UICONTROL Activities]** > **[!UICONTROL Channels]**&#x200B;에서 [이메일 게재](../../automating/using/email-delivery.md) 활동을 끌어다 놓습니다.
