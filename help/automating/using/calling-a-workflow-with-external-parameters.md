...
1. 매개 변수를 정의하고 워크플로우 **[!UICONTROL End]** 활동을 트리거하도록 **[!UICONTROL External signal]** 활동 또는 API 호출을 구성합니다. [이 페이지](../../automating/using/defining-parameters-calling-workflow.md) 보기
