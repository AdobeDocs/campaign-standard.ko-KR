...
[대상 매핑](../../administration/using/target-mappings-in-campaign.md)에서 구성되며, 쿼리 활동의 **[!UICONTROL Properties]** 탭에서 워크플로우를 만들 때 정의됩니다.
...
추가 데이터를 사용하여 전자 메일을 개인화하는 방법에 대한 사용 사례가 [이 섹션](../../automating/using/personalizing-email-with-additional-data.md)에 나와 있습니다.
