...
![faq 아이콘](start/using/assets/do-not-localize/icon-faq.svg){width="60px"}
...
![컨트롤 패널 아이콘](start/using/assets/do-not-localize/icon-control-panel.svg){width="60px"}
...
![지원 아이콘](start/using/assets/do-not-localize/icon-support.svg){width="60px"}
