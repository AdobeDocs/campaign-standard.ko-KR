...
이 Campaign 컨트롤 패널을 사용하면 각 인스턴스의 사용량을 추적하고 설정을 관리하여 Campaign Standard의 제품 관리자로서 작업의 효율성을 높일 수 있습니다.
자세한 내용을 보려면 [여기를 클릭하세요](https://experienceleague.adobe.com/docs/control-panel/using/discover-control-panel/key-features.html?lang=ko#discover-control-panel).
