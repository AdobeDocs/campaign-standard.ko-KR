...
+ 프로필 및 대상 {#profiles-and-audiences}
   ...
   + 구독 관리 {#managing-subscriptions}
      ...
      + [서비스 가입 확인](audiences/using/confirming-subscription-to-a-service.md)
   + 옵트인 및 옵트아웃 프로세스 이해 {#understanding-opt-in-and-opt-out-processes}
      ...
      + [전달에 대한 옵트아웃 프로필 확인](audiences/using/identifying-opt-out-profiles-for-a-delivery.md)
+ 커뮤니케이션 채널 {#communication-channels}
   + 통신 채널 정보 {#about-communication-channels}
      + [커뮤니케이션 채널 검색](channels/using/discovering-communication-channels.md)
   ...
   + 트랜잭션 메시지 {#transactional-messaging}
      + [트랜잭션 메시징 정보](channels/using/about-transactional-messaging.md)
      + [이벤트 트랜잭션 메시지](channels/using/event-transactional-messages.md)
      + [트랜잭션 메시지 프로파일링](channels/using/profile-transactional-messages.md)
...
+ 이메일 컨텐츠 디자인 {#designing-content}
   ...
   + [사용 및 권장 사항](designing/using/overview.md)
...
+ 보고 {#reporting}
   ...
   + 보고서 목록 {#list-of-reports}
      ...
      + [불만](reporting/using/complaints.md)
      + [배달 요약](reporting/using/delivery-summary.md)
      + [전달 처리량](reporting/using/delivery-throughput.md)
...
+ Adobe Cloud와 통합 {#integrating-with-adobe-cloud}
   ...
   + 캠페인 및 타겟 작업 {#working-with-campaign-and-target}
      + [Campaign-Target 통합 정보](integrating/using/about-campaign-target-integration.md)
   ...
   + 캠페인 및 분석 작업 {#working-with-campaign-and-analytics}
      + [Campaign-Analytics 통합 정보](integrating/using/about-campaign-analytics-integration.md)
   ...
   + Campaign 및 Audience Manager 또는 People 핵심 서비스 작업 {#working-with-campaign-and-audience-manager-or-people-core-service}
      + [Campaign-Audience Manager 또는 People 핵심 서비스 통합 정보](integrating/using/about-campaign-audience-manager-or-people-core-service-integration.md)
      + [Audience Manager 또는 People 코어 서비스와의 통합 제공 및 구성](integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)
   ...
   + [캠페인 및 자산 핵심 서비스 작업](integrating/using/working-with-campaign-and-assets-core-service.md)
   + 모바일용 캠페인 및 분석 작업 {#working-with-campaign-and-analytics-for-mobile}
      ...
      + [관심 영역 데이터를 사용하여 캠페인 메시지 개인화](integrating/using/personalizing-campaign-messages-with-point-of-interest-data.md)
...
+ 프로세스 및 데이터 관리 {#managing-processes-and-data}
   ...
   + 채널 활동 {#channel-activities}
      ...
      + [직접 메일 배달](automating/using/direct-mail-delivery.md)
   ...
   + 데이터 가져오기 및 내보내기 {#importing-and-exporting-data}
      ...
      + [가져오기 템플릿을 사용하여 데이터 가져오기](automating/using/importing-data-with-import-templates.md)
   ...
   + 활용 사례:워크플로우 {#workflow-use-case}
      + [보충으로 배달 만들기](automating/using/workflow-created-query-with-complement.md)
      + [생성 날짜에 배달 만들기](automating/using/workflow-creation-date-query.md)
      + [주별 배달 만들기](automating/using/workflow-weekly-offer.md)
      + [위치에 세그먼테이션 만들기](automating/using/workflow-segmentation-location.md)
      + [비열기 재타깃팅](automating/using/workflow-cross-channel-retargeting.md)
+ 개발 {#developing}
   + 사용자 지정 리소스 정보 {#about-custom-resources}
   ...
   + 리소스 추가 또는 확장 {#adding-or-extending-a-resource}
      ...
      + [복합 식별 키를 사용하여 리소스 호출](developing/using/uc-calling-resource-id-key.md)
   + 사용 사례:API 확장 {#use-case--extending-the-api}
      ...
      + [2단계:확장 프로그램 게시](developing/using/step-2--publish-the-extension.md)
      + [3단계:확장 프로그램 확인](developing/using/step-3--verify-the-extension.md)
   + 활용 사례:리소스 확장 {#use-cases--extending-resources}
      + [새 필드를 사용하여 프로필 리소스 확장](developing/using/extending-the-profile-resource-with-a-new-field.md)
      + [애플리케이션 리소스로 구독 확장](developing/using/extending-the-subscriptions-to-an-application-resource.md)
+ 관리 {#administrating}
   ...
   + 유형 규칙 작업 {#working-with-typology-rules}
      ...
      + [규칙 필터링](administration/using/filtering-rules.md)
