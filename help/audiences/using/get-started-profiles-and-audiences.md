...
# 프로필 및 대상자 시작하기{#about-profiles-and-audiences}
...
메시지에 **구독 취소 링크**&#x200B;를 제공하면 필요할 때 프로필에 추가하여 플랫폼 전달성을 향상시킬 수 있습니다. [차단 목록 및 관리에 대한 자세한 내용은 Campaign의 옵트아웃 정보](../../audiences/using/about-opt-in-and-opt-out-in-campaign.md)를 참조하세요.
