...
![](assets/do-not-localize/how-to-video.png) [비디오의 워크플로우를 사용하여 프로필을 가져오는 방법 살펴보기](#video)
...
1. 프로필 데이터를 입력합니다.
   ...
   * **[!UICONTROL Access authorization]** 범주는 [관리 권한](../../administration/using/about-access-management.md)에 대한 프로필의 조직 단위를 나타냅니다. 프로필에 조직 필드를 추가하려면 [프로필 파티션 나누기](../../administration/using/organizational-units.md#partitioning-profiles) 섹션을 참조하십시오.
...
이 비디오에서는 워크플로우로 프로필을 가져오는 방법을 보여 줍니다.
