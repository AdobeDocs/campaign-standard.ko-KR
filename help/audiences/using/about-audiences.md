...
* **[!UICONTROL Query]**: 대상자를 [쿼리](../../automating/using/editing-queries.md#about-query-editor) 대상자 목록을 통해 Adobe Campaign 데이터베이스의 데이터에 대해 자세히 알아보십시오. 쿼리로 정의한 대상자는 이후 사용할 때마다 다시 계산됩니다.
