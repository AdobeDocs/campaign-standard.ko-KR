...
product: campaign
title: 개인 정보 및 동의
description: Adobe Campaign Standard의 개인 정보, 개인 데이터 및 동의 관리에 대한 자세한 내용 알아보기
audience: start
...
>[!NOTE]
>
>GDPR, CCPA, PDPA 및 LGPD가 Adobe Campaign에 적용되는 방법에 대한 자세한 내용은 [이 섹션](../../start/using/privacy-management.md#privacy-management-regulations)을 참조하십시오.
...
**액세스** 및 **삭제** 요청이 [이 섹션](../../start/using/privacy-management.md#right-access-forgotten)에 표시됩니다.
