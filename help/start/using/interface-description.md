...
* **[!UICONTROL Create an In-App message]** 카드를 통해 인앱 생성 도우미로 이동할 수 있습니다. 이 도우미에서 만들려는 인앱 메시지 유형을 선택하고, 속성, 대상자 및 콘텐츠를 정의할 수 있습니다. [인앱 메시지 만들기](../../channels/using/about-in-app-messaging.md) 섹션을 참조하십시오.
* **[!UICONTROL Marketing activities]** 카드를 통해 모든 활동, 프로그램 및 캠페인, 특히 이메일, SMS, 워크플로 및 랜딩 페이지의 전체 목록으로 이동할 수 있습니다. 여기에서 이름, 날짜, 상태 또는 활동 유형별로 검색하여 요소를 필터링할 수 있습니다. 자세한 내용은 [마케팅 활동 목록](../../start/using/marketing-activities.md#about-marketing-activities) 섹션을 참조하십시오.
...
* **사용자** 아이콘을 사용하면 프로필에 연결된 정보를 표시할 수 있습니다. **[!UICONTROL Sign out]**&#x200B;해야 하는 경우 이 아이콘을 사용하십시오.
...
**[!UICONTROL Search]** 필드를 사용하여 지침을 찾으십시오. 검색 결과에는 설명서 및 도움말 문서, 커뮤니티 포럼 결과 및 비디오 콘텐츠가 포함되어 있으므로 더 많은 콘텐츠에 쉽게 액세스하여 애플리케이션을 최대한 활용할 수 있습니다.

다음과 같은 세 가지 탭을 통해 도움말 및 지원을 찾을 수 있습니다.

1. **[!UICONTROL Help]** 탭에는 다음이 포함됩니다.
   * 컨텍스트 링크를 통해 Adobe Campaign Standard 설명서에 빠르게 액세스할 수 있습니다.
   * Adobe Campaign 과정 라이브러리에 액세스할 수 있는 **[!UICONTROL Learning]** 링크입니다.
   * Campaign에 대한 질문 전용 포럼에 액세스하기 위한 **[!UICONTROL Community]** 링크.
   * 도움말 센터, 고객 지원 센터, Experience Cloud 제품 상태, 개발자 연결, 릴리스 정보, 릴리스 계획 및 **[!UICONTROL About]** 화면에 대한 직접 액세스 권한.
1. **[!UICONTROL Support]** 탭에서 지원 사례를 열고 전화 또는 X(이전 명칭: Twitter)로 문의할 수 있습니다.
1. **[!UICONTROL Feedback]** 탭을 사용하면 문제를 보고하거나 아이디어를 쉽게 공유할 수 있습니다.
...
* 워크플로 및 쿼리 편집기의 경우 팔레트가 있는 **작업 영역**&#x200B;을 사용하여 개체를 디자인할 수 있습니다.
...
* **작업 영역** 유형 화면과 관련된 작업은 워크플로의 [작업 표시줄](../../automating/using/workflow-interface.md#action-bar) 섹션을 참조하십시오.
