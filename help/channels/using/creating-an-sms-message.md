...
1. 교정쇄를 전송하여 메시지를 확인하고 유효성 검사를 할 수 있으며 받은 편지함 렌더링을 모니터링합니다. [교정쇄 전송](../../sending/using/sending-proofs.md) 섹션을 참조하십시오.
...
>[!VIDEO](https://video.tv.adobe.com/v/31897/?captions=kor&quality=12)
