...
1. 왼쪽 팔레트에서 **[!UICONTROL Form data]** 섹션에 액세스합니다.

1. 필드 유형을 변경하려면 **[!UICONTROL HTML type of the field]** 드롭다운 목록에서 값을 선택합니다.
...
1. **[!UICONTROL Field]** 영역에서 현재 선택한 데이터베이스 필드와 호환되지 않는 필드 유형을 선택하면 경고 메시지가 표시됩니다. 최적의 매핑을 위해 적절한 값을 선택합니다.

   ![](assets/lp_field-type-warning.png)

1. 양식 필드에 연결할 데이터베이스 필드를 선택하려면 **[!UICONTROL Field]** 영역을 사용합니다.
...
1. **[!UICONTROL Confirm]** 을 클릭하여 변경 내용을 저장합니다.
...
1. **[!UICONTROL Reconciliation key]** 을 선택합니다. 이 데이터베이스 필드는 방문자에게 Adobe Campaign 데이터베이스에 이미 알려진 프로필이 있는지 여부를 확인하는 데 사용됩니다. 예를 들어 이메일, 이름, 성 등이 있을 수 있습니다. 조정 키를 사용하면 아래에 정의된 **[!UICONTROL Update strategy]** 매개 변수에 따라 프로필을 업데이트하거나 만들 수 있습니다.

1. **[!UICONTROL Form parameter mapping]**&#x200B;을(를) 정의합니다. 이 섹션에서는 랜딩 페이지 필드 매개 변수와 조정 키에 사용되는 매개 변수를 매핑할 수 있습니다.

1. **[!UICONTROL Update strategy]** 을 선택합니다. 조정 키를 통해 기존 데이터베이스 프로필을 복구하는 경우, 양식에 입력한 데이터로 해당 프로필을 업데이트하거나 업데이트하지 못하도록 선택할 수 있습니다.
...
1. 랜딩 페이지를 디자인할 때:
   ...
   * 블록을 선택하고 **[!UICONTROL Form data]** 섹션에서 **[!UICONTROL Checkbox]** 을 필드 유형으로 선택합니다.

      ![](assets/lp_field-type-checkbox.png)

   * HTML에 익숙한 경우 **[!UICONTROL Show source]** 버튼을 사용하여 확인란을 수동으로 삽입할 수도 있습니다.
...
1. 컨텐츠에서 확인란이 선택되어 있는지 확인합니다. 왼쪽 팔레트의 **[!UICONTROL Form data]** 섹션에 **[!UICONTROL Type]** 드롭다운 목록이 표시됩니다. 목록에서 **[!UICONTROL Service and subscription]** 을 선택합니다.

   ![](assets/lp_service-and-subscription.png)

1. **[!UICONTROL Behavior]** 드롭다운 목록에서 옵션을 선택합니다.

   ![](assets/lp_checkbox-behavior.png)

1. 해당 목록에서 [서비스](../../audiences/using/creating-a-service.md)를 선택합니다.

   ![](assets/lp_checkbox-service.png)

1. **[!UICONTROL Mandatory]** 옵션이 선택 취소되어 있는지 확인합니다. 그렇지 않으면 사용자는 선택할 수 없습니다.
...
1. 왼쪽 팔레트의 **[!UICONTROL Form data]** 섹션에 **[!UICONTROL Type]** 드롭다운 목록이 표시됩니다. 목록에서 **[!UICONTROL Agreement]** 을 선택합니다.
