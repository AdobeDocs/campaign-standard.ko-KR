...
를 클릭하여 CSV 샘플을 확인합니다. **[!UICONTROL Download a sample file]** 에서 **[!UICONTROL Manage Content Variants]** 창을 엽니다. 자세한 내용은 다음을 참조하십시오 [섹션](../../channels/using/creating-a-multilingual-push-notification.md).
...
개인화 필드를 사용하려면 다음을 포함해야 합니다 <span> 태그에 다음 코드를 배치하십시오.
...
* 다른 하나는 data-nl-expr 이며, 이것은 개인화 필드의 경로입니다. 예를 들어 UI에서 &quot;firstName&quot; 개인화 필드를 삽입하면 탐색 경로가 **[!UICONTROL Context (context)]** > **[!UICONTROL Profile (profile)]** > **[!UICONTROL First name (firstName)]** (아래 이미지에 표시된 대로). 이 경우 경로는
