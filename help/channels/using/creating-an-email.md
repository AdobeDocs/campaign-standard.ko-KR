...
1. 교정쇄를 전송하여 메시지를 확인하고 유효성 검사를 할 수 있으며 받은 편지함 렌더링을 모니터링합니다. [증명 보내기](../../sending/using/sending-proofs.md)를 참조하세요.
...
>[!VIDEO](https://video.tv.adobe.com/v/29753?captions=kor&quality=12)
