...
이 예에서는 [에서 이벤트](../../administration/using/configuring-transactional-messaging.md#use-case--configuring-an-event-to-send-a-transactional-message)를 만들 때 정의한 세 개의 필드를 추가하여 트랜잭션 메시지를 개인화하는 방법을 알아봅니다.이름, 마지막 제품 상담, 총 장바구니 금액

이렇게 하려면 메시지 내용에 개인화 필드](../../designing/using/personalization.md#inserting-a-personalization-field)을(를) 삽입합니다.[
...
1. 개인화 필드를 가져오려면 **[!UICONTROL Context]** > **[!UICONTROL Real-time event]** > **[!UICONTROL Event context]**&#x200B;를 검색하십시오.이름, 마지막 제품 상담, 총 장바구니 금액
...
[이 비디오](https://docs.adobe.com/content/help/en/campaign-learn/campaign-standard-tutorials/designing-content/product-listings-in-transactional-email.html)에서 자세히 알아보십시오.
...
### 1단계:{#defining-a-product-listing} 제품 목록 정의
...
### 2단계:제품 목록 {#populating-the-product-listing} 채우기
