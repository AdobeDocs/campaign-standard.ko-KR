...
미리 보기, 전자 메일 렌더링, 증명 등 Campaign Standard 기능을 사용하여 메시지를 보내기 전에 **메시지를 확인하고 테스트하십시오**. 자세한 정보는 [이 섹션](../../sending/using/previewing-messages.md)을 참조하세요.
...
메시지 게재를 모니터링하는 데 도움이 되는 몇 가지 로그를 사용할 수 있습니다([게재 모니터링](../../sending/using/monitoring-a-delivery.md) 참조). Campaign Standard의 [추적 기능](../../sending/using/tracking-messages.md)을 통해 게재 수신자의 동작을 추적할 수도 있습니다.
