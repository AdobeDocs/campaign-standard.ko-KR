...
관리자는 Admin Console에서 사용자를 관리할 수 있습니다. 그러면 사용자가 Adobe Campaign와 자동으로 동기화됩니다. For more on this, refer to the [Admin console](https://helpx.adobe.com/enterprise/using/users.html) documentation.
...
* [기능 관리자](../../administration/using/users-management.md#functional-administrators): 모든 조직의 사용자 중에서 가장 전문적인 기술
* [고급 사용자](../../administration/using/users-management.md#advanced-users): 마케터가 배달을 전송하고 모니터링해야 하는 모든 요소를 설정합니다.
* [기본 사용자](../../administration/using/users-management.md#basic-users): 캠페인을 개인화, 전달 및 모니터링하는 마케터입니다.
...
사용자를 인스턴스에 추가하려면 먼저 Adobe Campaign Standard에서 관리 콘솔로 먼저 만들어야 합니다.
...
1. **[!UICONTROL User details]** 탭에서 이메일 주소, 이름 및 성과 같은 사용자의 세부 정보를 입력합니다.

   ![](assets/create_user_3.png)

1. **[!UICONTROL Assign products]** 탭에서 하나 또는 여러 개의 보안 그룹을 사용자에게 지정합니다. For more information on security groups, refer to this [page](../../administration/using/managing-groups-and-users.md).
...
1. 사용자의 보안 그룹을 확인합니다. Here, you can see that the user has been assigned the **[!UICONTROL Administrators]** security group.

   >[!NOte]
   >
   >보안 그룹은 관리 콘솔의 사용자만 제거하거나 추가할 수 있습니다.
