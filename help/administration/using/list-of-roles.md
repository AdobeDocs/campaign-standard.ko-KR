...
* **[!UICONTROL Administration]**: 일반 관리 권한.
  ...
  >[!NOTE]
  >
  >Experience Cloud 트리거를 사용하여 작업하는 경우 Experience Cloud 트리거 메뉴에 액세스할 수 있는 **[!UICONTROL Administration]** 권한이 필요합니다. Experience Cloud 트리거에 대한 자세한 내용은 이 [페이지](../../integrating/using/about-adobe-experience-cloud-triggers.md)를 참조하세요.
