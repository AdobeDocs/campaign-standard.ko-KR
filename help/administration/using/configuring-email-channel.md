...
* **권한 있는 마스크 필드**
  ...
  **[!UICONTROL Header parameters of sent emails]** 섹션에는 전자 메일을 받는 사람(보낸 사람 주소)에게 보내고 비동기 바운스, 부재 중 회신 등과 같은 자동 답글(오류 주소)을 다시 보낼 수 있도록 할 수 있는 권한이 있는 전자 메일 주소가 나열됩니다.
...
* **[!UICONTROL Typology]**: 전송 전에 콘텐츠와 구성을 확인하기 위해 메시지를 준비해야 합니다. 준비 단계 동안 적용된 확인 규칙은 **유형화**&#x200B;에서 정의됩니다. 예를 들어 이메일의 경우, 준비 과정에는 제목, URL 및 이미지 등이 포함됩니다. 이 필드에 적용할 유형화를 선택합니다.
