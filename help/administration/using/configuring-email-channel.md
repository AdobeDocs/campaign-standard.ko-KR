...
이 섹션에서는 이메일 또는 [이메일 템플릿의](../../start/using/about-templates.md)속성 화면에서 사용할 수 있는 매개 변수 목록을 자세히 설명합니다.
...
이메일 숨은 참조는 [이메일 템플릿에서](../../start/using/about-templates.md)전용 옵션을 통해 활성화됩니다.
