...
Adobe Campaign을 사용하면 iOS 및 Android 모바일 장치의 개인화 및 세그먼트화된 푸시 알림을 모바일 애플리케이션(모바일 앱)에 보낼 수 있습니다.
...
**[iOS APNS 테스터에 사용할 JSON 샘플 페이로드](https://pushtry.com/)**
...
페이로드의 가장 중요한 섹션은 aps 사전이며, Apple에서 정의한 키를 포함하고 있으며, 알림을 받는 시스템이 알림을 받는 경우 사용자에게 어떻게 경고해야 하는지 결정하는 데 사용됩니다. 이 섹션에는 푸시 알림의 동작을 만들기 위해 모바일 앱에서 사용하는 사전 정의된 키가 포함되어 있습니다.

aps 내의 속성에 대한 세부 정보는 Apple 개발자 문서에서 찾을 수 있습니다. [원격 알림 페이로드 만들기](https://developer.apple.com/library/archive/documentation/NetworkingInternet/Conceptual/RemoteNotificationsPG/CreatingtheNotificationPayload.html#//apple_ref/doc/uid/TP40008194-CH10-SW1)
...
**Google FCM 테스터를 사용하기 위한  [JSON 샘플 페이로드](https://pushtry.com/)**
...
|:-:|:-:|:-:|:-:|
| 메시지 제목 <br>메시지 본문 | 경고 → 제목 <br> 경고 → 본문 | 제목 <br>본문 | 이 데이터에는 경고 메시지의 세부 사항이 포함됩니다.<br>제목 및 본문 키는 경고 내용을 제공합니다. |
