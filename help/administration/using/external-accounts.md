...
Azure Blob 저장소 커넥터를 사용하여 전송 파일 워크플로우 활동을 사용하여 데이터를 Adobe Campaign으로 가져오거나 **[!UICONTROLT내보낼 수]** 있습니다. For more on this, refer to this [section](../../automating/using/transfer-file.md#azure-blob-configuration-wf).
