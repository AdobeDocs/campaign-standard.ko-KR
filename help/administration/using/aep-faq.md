...
자세한 정보는 이 [페이지](https://developer.adobe.com/client-sdks/documentation/adobe-campaign-standard){target="_blank"}를 참조하십시오.
...
## Adobe Campaign Standard에서 Adobe Experience Platform SDK 통합이 용이하게 하는 사용 사례는 무엇입니까? {#aep-use-cases}
...
## Adobe Experience Platform SDK(이전 이름: SDK V5)에 대해 자세히 알아볼 수 있는 유용한 리소스 권장 사항은 무엇입니까?{#resource-aep}
...
* Experience Platform SDK [설명서](https://developer.adobe.com/client-sdks/resources/upgrade-platform-sdks/)&#x200B;(으)로 업그레이드
