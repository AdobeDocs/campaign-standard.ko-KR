...
1. **티켓 만들기** - 하위 도메인이 구성되면 Adobe이 프로덕션 환경에서 설정합니다. 이를 요청하려면 다음 정보를 사용하여 [Client Care에 대한 티켓을 만듭니다](https://helpx.adobe.com/kr/enterprise/using/support-for-experience-cloud.html).
