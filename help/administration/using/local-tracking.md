...
Adobe Campaign Standard에 대한 추적을 구현하려면 모바일 애플리케이션이 모바일 SDK을 애플리케이션에 포함해야 합니다. 이러한 SDK는 [!DNL Adobe Mobile Services]에서 사용할 수 있습니다.
...
Adobe Experience Platform Mobile SDK은 추가 구성 없이 Android과 iOS 모두에 대한 노출 이벤트를 자동으로 전송합니다.
