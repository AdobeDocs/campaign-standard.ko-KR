...
>[!NOTE]
XDM 매핑 요청 상태 및 관련 작업에 대한 자세한 내용은 Campaign Standard 인터페이스에서 플랫폼 **!UICONTROL [으로 데이터 내보내기&#x200B;]**상태 메뉴에서 사용할 수 있습니다(매핑 활성화[참조](../../administration/using/aep-mapping-activation.md)).
