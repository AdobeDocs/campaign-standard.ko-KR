...
차원과 지표 간의 호환성에 대한 자세한 내용은 다음을 참조하십시오. [표](/help/reporting/using/assets/dynamic_report_compatibility.pdf). 두 구성 요소가 호환되지 않으면 셀에 값이 표시됩니다 **없음**.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 도시<br /> </td> 
   <td> 수신자 프로필에 등록된 도시입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 국가/지역<br /> </td> 
   <td> 수신자 프로필에 등록된 국가입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 게재<br /> </td> 
  ...
  <tr> 
   <td> 성별<br /> </td> 
   <td> 남성 또는 여성 등 수신자의 성별. 수신자 프로필의 성별 필드가 비어 있는 경우 값은 none이 됩니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 인앱 메시지 작업<br /> </td> 
   <td> 전달된 인앱 메시지에 대한 작업(예: 버튼 1 또는 2에 대한 작업 또는 해제)<br /> </td> 
  </tr> 
  <tr> 
   <td> 메시지 유형<br /> </td> 
   <td> 이메일, SMS, 푸시 알림 또는 인앱 등 게재에 사용되는 채널.<br /> </td> 
  </tr> 
  <tr> 
   <td> 모바일 앱 이름<br /> </td> 
  ...
  <tr> 
   <td> 프로필<br /> </td> 
   <td> 프로필 리소스 확장 중에 생성된 기본 제공 및 사용자 지정 프로필 필드를 다시 그룹화합니다. 자세한 내용은 다음을 참조하십시오. <a href="../../developing/using/key-steps-to-add-a-resource.md">페이지</a> 또는 이 <a href="../../reporting/using/creating-a-custom-profile-dimension.md">예</a>.<br /> 이 차원에 대한 데이터는 프로필 필드에 연결된 사용자 지정 리소스가 게시되는 즉시 검색됩니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 푸시 플랫폼<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 바운스 + 오류<br /> </td> 
   <td> 총 보낸 메시지 수와 관련하여 게재 중에 누적된 총 오류(예: MCPNS 또는 제공자의 오류).<br /> </td> 
  </tr> 
  <tr> 
   <td> 바운스 + 오류 비율<br /> </td> 
  ...
  <tr> 
   <td> 클릭<br /> </td> 
   <td> 푸시 알림이 디바이스에 전달되고 사용자가 클릭한 횟수. 사용자는 푸시 오픈 추적으로 이동될 알림을 보거나 닫으려고 했습니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 클릭스루 비율<br /> </td> 
  ...
  <tr> 
   <td> 노출 횟수<br /> </td> 
   <td> 푸시 알림이 디바이스에 전달되고 알림 센터에 그대로 남아 있는 횟수입니다. 대부분의 경우 노출 횟수는 게재된 횟수와 유사해야 합니다. 이렇게 하면 장치가 메시지를 받고 해당 정보를 서버에 다시 전달했는지 확인할 수 있습니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 처리됨/전송됨<br /> </td> 
  ...
  <tr> 
   <td> 고유 클릭수<br /> </td> 
   <td> 고유 사용자가 푸시 알림과 상호 작용하는 횟수(예: 알림 또는 버튼 클릭)<br /> </td> 
  </tr> 
  <tr> 
   <td> 고유 노출 횟수<br /> </td> 
   <td> 수신자별 노출 횟수.<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 메시지를 본 사용자와 비교하여 단추 1 또는 단추 2를 클릭한 사용자의 비율입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 인앱 해고<br /> </td> 
   <td> 닫기 단추 또는 자동 닫기 단추를 클릭하여 수신자가 해제한 총 메시지 수입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 인앱 기각률<br /> </td> 
   <td> 수신자가 해제한 인앱 메시지 비율입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 처리됨/전송됨<br /> </td> 
   <td> 전송된 게재 프로세스의 일부로 Adobe Campaign에서 전송된 총 인앱 메시지 수입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 고유 노출 횟수<br /> </td> 
  ...
  <tr> 
   <td> 고유한 인앱 취소<br /> </td> 
   <td> 수신자가 인앱 메시지를 해제한 시간 수.<br /> </td> 
  </tr> 
 </tbody> 
</table>
