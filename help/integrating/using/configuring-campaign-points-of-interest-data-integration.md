...
>[!NOTE]
>
>모바일 애플리케이션은 이미 Adobe Experience Platform SDK을 사용하여 Adobe Campaign Standard에 구성되어야 합니다. 자세한 단계는 이 [페이지](https://helpx.adobe.com/kr/campaign/kb/configuring-app-sdk.html)를 참조하세요.

위치 데이터를 수집하는 데 사용되는 모바일 응용 프로그램은 Adobe Campaign 인터페이스에서 **관리자**&#x200B;가 구성해야 합니다.

Adobe Experience Platform SDK으로 구성된 모바일 애플리케이션에서 Adobe Experience Platform 위치 서비스를 사용하려면 다음을 수행해야 합니다.
...
1. 모바일 애플리케이션의 특정 설정을 수행합니다.
   ...
   * Experience Cloud Mobile SDK을 모바일 애플리케이션에 통합합니다. [모바일 애플리케이션에 SDK 통합](#integrating-the-sdk-into-a-mobile-application)을 참조하십시오.
...
* **[!UICONTROL Collect PII endpoint]** URL은 시작할 때 모바일 애플리케이션에서 사용자의 Experience Cloud ID 및 등록 토큰을 수집하는 데 사용됩니다. 사용자가 이메일, 이름, 성 등의 자격 증명을 사용하여 애플리케이션에 로그인할 때 이 데이터도 수집되어 사용자의 등록 토큰을 Adobe Campaign 프로필과 조정하는 데 사용됩니다.
...
1. 포스트백을 만듭니다.
   ...
   * **포스트백을 트리거하는 데이터 태그가 무엇입니까?**&#x200B;에서 이벤트를 선택합니다(일반적으로 **[!UICONTROL Launched]** 및 **[!UICONTROL exists]**).
...
1. 두 번째 포스트백을 만듭니다.
   ...
   * **콘텐츠 형식**&#x200B;을(를) **[!UICONTROL application/json]**(으)로 설정합니다.
   * **포스트백을 트리거하는 데이터 태그가 무엇입니까?**&#x200B;에서 **[!UICONTROL campaign.test]** 및 **[!UICONTROL exists]**&#x200B;을(를) 선택합니다.
   * **[!UICONTROL Save & Activate]**&#x200B;을(를) 클릭합니다.
...
Mobile Core Service의 소프트웨어 개발 키트(SDK)를 사용하면 모바일 애플리케이션을 Adobe Campaign에 쉽게 통합할 수 있습니다.
...
이 단계는 [SDK V4를 사용하여 모바일 애플리케이션 구성](https://helpx.adobe.com/kr/campaign/kb/configuring-app-sdkv4.html) 페이지에 설명되어 있습니다.
