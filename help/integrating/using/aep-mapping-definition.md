---
title: 매핑 정의
description: Campaign Standard 필드를 XDM(경험 데이터 모델) 필드와 매핑하는 방법에 대해 알아봅니다.
...
**[!UICONTROL Create new field mapping]** 단추를 사용하면 Campaign Standard 필드와 XDM 스키마의 해당 필드 경로 식을 선택할 수 있습니다.
