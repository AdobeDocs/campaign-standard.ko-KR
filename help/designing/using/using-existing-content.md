...
이메일 디자이너 내에서 기존 외부 컨텐츠를 완전히 편집 가능하도록 하려면 기존 컨텐츠[ 섹션을 사용하여 이메일 디자인 섹션을 참조하십시오.](../../designing/using/using-existing-content.md)
...
업로드된 HTML의 전체 또는 일부가 예상 태깅과 호환되지 않는 경우 컨텐츠는 &#39;호환성 모드&#39;로 로드되며, 이는 UI를 통해 버전 가능성을 제한합니다.
