...
>[!NOTE]
>
>URL에서 컨텐츠를 로드하는 것은 이메일 채널에서만 사용할 수 있습니다.
...
업로드된 HTML의 전체 또는 일부가 예상 태깅 호환하지 않는 경우 컨텐츠가 &#39;호환성 모드&#39;로 로드되어 UI를 통해 버전 가능성을 제한합니다.
...
이 사용 사례에서는 HTML 이메일을 이메일 디자이너 구성 요소로 신속하게 변환하는 방법을 제공합니다.
...
이메일 디자이너 외부에서 원본 HTML이 재사용 가능한 섹션으로 나누어져 있는지 확인합니다.
...
모든 블록을 식별한 후에는 이메일 디자이너에서 기존 이메일의 각 섹션에 대해 다음 절차를 반복합니다.
