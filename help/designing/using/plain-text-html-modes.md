...
고급 사용자 및 디버깅의 경우 HTML에서 직접 이메일 콘텐츠를 보고 편집할 수 있습니다.
...
* WYSIWYG 인터페이스에서 요소를 선택하고 **[!UICONTROL Source code]** 아이콘을 클릭합니다.
  ...
  선택한 요소의 소스만 표시됩니다. 선택한 요소가 **[!UICONTROL HTML]** 콘텐츠 구성 요소인 경우 소스 코드를 편집할 수 있습니다. 다른 구성 요소는 읽기 전용 모드이지만 전체 HTML 버전의 이메일에서 계속 편집할 수 있습니다.
...
1. 텍스트 편집, 새 이미지 업로드, 새 구성 요소 추가 등과 같은 이메일 구조 또는 콘텐츠에 대한 다른 변경 사항도 표준 보기에 적용됩니다.
