...
이러한 조건은 XTK 표현식 구문(예: **context.profile.email !=&#39;&#39;** 또는 **context.profile.status=&#39;0&#39;**)을 채택합니다. 기본적으로 모든 필드가 표시됩니다.
...
1. 동적으로 표시하려는 이메일의 다른 요소에 대해서도 유사하게 진행합니다. 텍스트, 버튼, 조각 등이 될 수 있습니다. 변경 사항을 저장합니다.
