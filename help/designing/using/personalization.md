...
1. **[!UICONTROL Depends on format]** 옵션을 선택하여 HTML 이메일과 텍스트 형식의 이메일에 대해 각각 다른 두 개의 블록을 정의할 수 있습니다. 그러면 편집기(HTML 및 텍스트)에 해당 콘텐츠를 정의할 수 있는 두 개의 탭이 표시됩니다.
...
>[!CAUTION]
>
>블록의 내용을 편집할 때 *if* 문의 시작과 끝 사이에 추가 공백이 없는지 확인하십시오. HTML 시 공백은 화면에 표시되므로 컨텐츠 레이아웃에 영향을 미칩니다.
