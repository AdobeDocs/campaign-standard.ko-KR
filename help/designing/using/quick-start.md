...
* 템플릿을 선택하고 여기에서 새 이메일 컨텐츠를 작성하여 바로 사용할 수 있는 템플릿에서 이메일을 만들 수 있습니다. [자세한 내용](../../designing/using/quick-start.md#building-content-from-an-out-of-the-box-template)

기존 컨텐츠가 있는 이메일을 만들 수도 있습니다.

* 기존 HTML 컨텐츠(외부에서 또는 레거시 편집기에서 작성)를 변환할 수 있습니다. [자세한 내용](../../designing/using/quick-start.md#converting-an-html-content)
* 호환성 모드에서 기존 HTML 콘텐츠를 바로 가져올 수 있습니다. [자세한 내용](../../designing/using/quick-start.md#compatibility-mode)
...
호환성 모드에서는 드래그 앤 드롭을 사용할 수 없지만 기존 편집기와 동일한 기능 세트가 보장됩니다.
