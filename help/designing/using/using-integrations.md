...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 지원됨<br /> </td> 
   <td> AEM에서 미리 보기<br /> Campaign에서 증명<br /> </td> 
  ...
  <tr> 
   ...
   <td> 
     ...
     <p>- 이메일 콘텐츠에서 Experience Manager의 강력한 기능 활용</p>
    </td> 
   <td> 
  ...
  <tr> 
   ...
   <td> 개인화가 거의 없는 표준 전자 메일 템플릿을 사용하려는 Experience Manager을 이미 사용 중인 마케터<br /> </td> 
