...
* 이제 랜딩 페이지를 디자인할 때 양식을 제출하기 전에 프로필에서 선택해야 하는 필수 확인란을 추가할 수 있습니다.
...
* 이제 이메일의 최대 용량이 100MB로 기본 설정됩니다. 이 제한을 통해 이메일 용량을 무한정 늘려 시스템 충돌을 야기할 수 있는 오류를 방지합니다. (CAMP-47445)
...
* 일부 인스턴스에서 추적 로그가 누락되는 문제를 해결했습니다. 이러한 손실된 추적 로그를 복원하기 위한 기술 워크플로우(**trackingLogRecovery**)가 새로 추가되었습니다. 이 워크플로우는 Adobe 내부에서만 사용해야 합니다.
...
* **보고서 보내기 예약** 옵션을 사용한 후에 보고서가 수신되지 않던 문제를 해결했습니다. (CAMP-48583)

* **지금 보고서 보내기 옵션**&#x200B;을 사용한 후에 받은 보고서가 불완전하고 데이터가 누락되어 있는 문제를 해결했습니다. (CAMP-48583)

* 동적 보고서의 **보고서 보내기 예약** 옵션에서 **즉시 보고서 공유**(reportSendingNow) 워크플로우가 보고서 생성에 실패하는 문제를 해결했습니다. (CAMP-47786)
