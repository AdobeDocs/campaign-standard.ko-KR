...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <p>구현을 조정하고 최신 Experience Platform SDK으로 이동하는 방법을 배우려면 <a href="https://experienceleague.adobe.com/docs/campaign-standard/using/administrating/configuring-mobile/sdkv4-migration.html?lang=ko">이 문서</a>를 읽어 보십시오.</p></br>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <p>SDK v4에서 Adobe Experience Platform Mobile SDK으로 마이그레이션하는 방법에 대해 알아보세요. <a href="https://experienceleague.adobe.com/docs/campaign-standard/using/administrating/configuring-mobile/sdkv4-migration.html?lang=ko">이 페이지</a>.</p></br>
     </td> 
  </tr> 
 </tbody> 
</table>
