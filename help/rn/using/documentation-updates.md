...
새로운 섹션에서는 Adobe Experience Platform 소스 및 대상을 사용하여 Campaign Standard 및 Adobe 실시간 고객 데이터 플랫폼(RTCDP) 간에 데이터를 공유하는 방법에 대해 설명합니다. [자세히 알아보기](../../integrating/using/get-started-sources-destinations.md)
