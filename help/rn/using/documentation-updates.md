...
차단 목록 전용 섹션의 이름이 &quot;옵트인 및 옵트아웃 프로세스 이해&quot;로 변경되었습니다. 특정 채널에 대한 옵트인을 관리하는 방법 및 랜딩 페이지를 설정하여 옵트인 및 옵트아웃을 관리하는 방법에 대한 정보를 업데이트했습니다. [자세한 내용](../../audiences/using/about-opt-in-and-opt-out-in-campaign.md)
