...
프로필 대체를 사용하여 증명을 보내면 선택한 프로필의 로그에 레코드가 추가된다는 점을 알기 위한 메모입니다. [자세히 보기](../../sending/using/testing-messages-using-target.md)
...
콘텐츠 Campaign Standard 설명서 표에 Campaign Campaign 컨트롤 패널 설명서에 대한 직접 링크를 추가했습니다.
