...
seo-description: Adobe Campaign Standard 설명서에 대한 모든 최신 업데이트에 대해 알아보십시오.
...
예정된 릴리스 날짜를 공유하기 위해 새로운 릴리스 계획 문서가 게시되었습니다. [자세히 보기](https://helpx.adobe.com/campaign/kb/acs-release-planning.html)
...
업데이트 및 유지 관리 작업에 대한 섹션이 추가되었습니다. [자세히 보기](../../administration/using/updates-and-maintenance-operations.md)

**파일 전송** 활동의 새 정렬 옵션에 정보가 추가되었습니다. [자세히 보기](../../automating/using/transfer-file.md)

[REST API 설명서가](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html) 업데이트되었습니다.

* 캠페인 Standard REST API를 사용하는 이유에 대한 일반 정보가 추가된 새로운 섹션이 추가되었습니다.
* 미리 디자인된 API 요청의 컬렉션이 사용 가능하도록 되어 일반적인 사용 사례가 표시됩니다.
* 조직 단위를 관리하는 방법에 대한 새로운 섹션이 추가되었습니다.
...
동적 보고서에 대한 표시기 계산 섹션이 업데이트되었습니다. [자세히 보기](../../reporting/using/indicator-calculation.md)

차원과 지표 간의 호환성을 더 잘 이해하기 위해 동적 보고 호환성 표가 추가되었습니다. [자세히 보기](https://docs.campaign.adobe.com/doc/standard/en/Technotes/dynamic_report_compatibility.pdf)

워크플로우에 대한 함수 목록이 업데이트되었습니다. [자세히 보기](../../automating/using/list-of-functions.md)

기존 콘텐츠를 사용하는 이메일 디자이너와 이메일을 디자인하기 위한 다양한 방법을 명확하게 설명하는 새로운 섹션을 통해 컨텐츠 디자인 챕터가 재구성되고 향상되었습니다. [자세히 보기](../../designing/using/about-email-content-design.md#designing-an-email-using-existing-contents)

이메일 디자이너의 조각으로 이메일 컨텐츠를 저장하는 방법에 대한 새로운 섹션이 추가되었습니다. [자세히 보기](../../designing/using/defining-the-email-structure.md#saving-content-as-a-fragment)

링크 관리 섹션이 이메일 디자이너에서 추적된 URL를 관리하는 방법에 대한 추가 정보로 업데이트되었습니다. [자세히 보기](../../designing/using/inserting-a-link.md)

특정 트랜잭션 메시지 재시도 프로세스를 설명하는 새 섹션이 추가되었습니다. [자세히 보기](../../channels/using/event-transactional-messages.md#transactional-message-retry-process)

API 확장 기능을 사용하여 리소스 게시 섹션이 명확하게 구분되어 최신 UI 변경 사항으로 업데이트되었습니다. [자세히 보기](../../developing/using/updating-the-database-structure.md#publishing-a-resource-with-api-extension)

이메일 보관 섹션의 이름이 변경되었으며 재구성되었습니다. [자세히 보기](../../administration/using/configuring-email-channel.md#archiving-emails)

이메일 만들기 섹션이 최신 인터페이스가 변경된 것을 반영하도록 업데이트되었습니다. [자세히 보기](../../channels/using/creating-an-email.md)

[SMS 커넥터 프로토콜 및 설정](https://helpx.adobe.com/campaign/kb/sms-connector-protocol-and-settings.html) 기술 자료 문서가 SMS 외부 계정에 추가된 새 옵션으로 업데이트되어 SMPP 공급자에 연결할 수 있는 MTA 인스턴스의 수를 제한합니다.

시작하기 안내서는 풍부하게 재구성되었습니다. [자세히 보기](../../start/using/campaign-orchestration.md)

더 이상 사용되지 않거나 제거된 기능 페이지가 업데이트되었습니다. [자세히 보기](https://helpx.adobe.com/campaign/kb/acs-deprecated-and-removed-features.html)
...
트랜잭션 메시징 제한 사항에 대한 새로운 섹션이 추가되었습니다. [자세히 보기](../../channels/using/about-transactional-messaging.md#transactional-messaging-limitations)

Adobe Campaign의 다른 이메일 작성 옵션을 비교한 새 섹션이 추가되었습니다. [자세히 보기](../../designing/using/about-email-content-design.md#email-design-options-comparison)

사용자 지정 콘텐츠 블록 만들기 섹션이 타깃팅 차원에 대한 세부 사항과 함께 향상되었습니다. [자세히 보기](../../designing/using/adding-a-content-block.md#creating-custom-content-blocks)

이메일 디자이너가 Internet Explorer 11를 지원하지 않는다는 경고가 추가되었습니다. [자세히 보기](../../start/using/compatible-browsers.md)

재작성 시 미치는 영향에 대한 경고가 리소스 삭제 섹션에 추가되었습니다. [자세히 보기](../../developing/using/deleting-a-resource.md)

리소스를 추가 또는 확장하는 방법에 대한 장이 업데이트되었습니다. [자세히 보기](../../developing/using/creating-or-extending-the-resource.md)

프로필 사용자 지정 리소스를 확장하는 방법에 대한 사용 사례가 추가되었습니다. [자세히 보기](../../developing/using/extending-the-profile-resource-with-a-new-field.md)

사용자 지정 리소스를 연결하는 방법에 대한 정보가 추가되었습니다. [자세히 보기](../../developing/using/configuring-the-resource-s-data-structure.md#defining-links-with-other-resources)

Adobe Campaign Standard 푸시 알림에서 이미지를 표시하는 방법에 대한 새로운 technote가 추가되었습니다. [자세히 보기](https://helpx.adobe.com/content/help/en/campaign/kb/display-image-push.html)

푸시 추적 구현에 대한 새로운 Technote가 추가되었습니다. [자세히 보기](https://helpx.adobe.com/content/help/en/campaign/kb/push-tracking.html)

Campaign Standard 및 Classic에 대한 오류 메시지 목록이 업데이트되었습니다. [자세히 보기](https://docs.campaign.adobe.com/doc/AC/en/technicalResources/error_messages/error_codes.html)

트리거 - 캠페인 통합 설명서가 업데이트되었습니다. [자세히 보기](../../integrating/using/about-adobe-experience-cloud-triggers.md)

Adobe Campaign에서 직접 사용할 수 있는 컨텍스트 도움말 링크 업데이트.

거부사항이 들어 있는 파일 이름에 타임스탬프를 추가할 때 참고가 추가되었습니다. [자세히 보기](../../automating/using/load-file.md#configuration)

고정 길이의 열로 이루어진 필드를 가져올 때 정보가 추가되었습니다. [자세히 보기](../../automating/using/load-file.md#configuration)

파일의 거부 상태를 유지할 수 있는 옵션에 대한 정보가 추가되었습니다. 이제 이 옵션을 사용하면 거부사항이 포함된 파일에 후처리 단계를 적용할 수 있습니다. [자세히 보기](../../automating/using/load-file.md#configuration)
...
Adobe Campaign의 다른 유형의 대상과 관련된 정보가 추가되었습니다. [자세히 보기](../../audiences/using/about-audiences.md)

지리적 판매의 감가상각을 반영하도록 사용자 및 보안 장을 업데이트했습니다. [자세히 보기](../../administration/using/organizational-units.md)

거부된 레코드 (예: ZIP 형식 압축을 참조하십시오. [자세히 보기](../../automating/using/load-file.md)

업로드할 데이터의 최대 일괄 처리 크기를 구성할 수 있도록 해주는 업데이트 데이터 활동의 새 필드에 대한 정보가 추가되었습니다. [자세히 보기](../../automating/using/update-data.md)

[URL](../../designing/using/importing-content-from-a-url.md) 설명서에서 이메일 디자이너와 관련된 정보가 포함된 컨텐츠를 가져오었습니다.

Microsoft Edge (최신 버전) 가 컴퓨터의 호환 브라우저 목록에 추가되었습니다. [자세히 보기](../../start/using/compatible-browsers.md)
...
대상자를 삭제하는 방법에 대한 정보가 추가되었습니다. [자세히 보기](../../audiences/using/creating-audiences.md#deleting-audiences)
...
Adobe Campaign 문서와의 Experience Manager 통합을 업데이트했습니다. [자세히 보기](../../reporting/using/creating-a-custom-profile-dimension.md)

" 컨텐츠 디자인 "가이드는 완전히 재구성되어, 이메일 컨텐츠를 디자인하는 데 사용할 수 있는 두 편집기를 제시했습니다. [자세히 보기](../../designing/using/about-email-content-design.md)
...
사용자 지정 프로필 차원을 만드는 방법에 대한 단계별 사용 사례가 추가되었습니다. [자세히 보기](../../reporting/using/creating-a-custom-profile-dimension.md)

캠페인 및 Audience Manager 또는 People 핵심 서비스 문서 작업을 재구성되었습니다. [자세히 보기](../../integrating/using/about-campaign-audience-manager-or-people-core-service-integration.md)

배달 준비 역할 정의를 업데이트했습니다. [자세히 보기](../../administration/using/list-of-roles.md)
...
관리 메뉴의 라이선스 옵션에 대한 정보가 추가되었습니다. [자세히 보기](../../administration/using/licenses.md)

푸시 알림에서 사용자 정의 필드를 사용하는 방법에 대한 정보가 추가되었습니다. [자세히 보기](../../channels/using/customizing-a-push-notification.md#add-custom-fields)

업데이트된 전달 모범 사례 단계별 가이드입니다. [자세히 보기](https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_DeliveryBestPractices.html)

추적 로그 유형에 대한 정보가 추가되었습니다. [자세히 보기](../../sending/using/tracking-messages.md#tracking-logs)

쿼리 활동 섹션이 쿼리 샘플로 업데이트되었습니다. [자세히 보기](../../automating/using/query.md#query-samples)

블랙리스트 전용 섹션의 이름이 "옵트인 및 옵트아웃 프로세스 이해" 로 변경되었습니다. 특정 채널에 대한 옵트인 관리 방법에 대한 정보와 동의 및 옵트아웃을 관리하기 위한 랜딩 페이지를 설정하는 방법에 대한 정보가 업데이트되었습니다. [자세히 보기](../../audiences/using/about-opt-in-and-opt-out-in-campaign.md)

Adobe 호스팅 SFTP 서버를 사용하는 모범 사례를 알아봅니다. [자세히 보기](../../administration/using/external-accounts.md#sftp-external-account)

트리거와의 통합에 대해 지원되는 Analytics SKU 목록이 업데이트되었습니다. [자세히 보기](../../integrating/using/configuring-triggers-in-experience-cloud.md#configuring-solutions-and-services)
...
스케줄러 활동 섹션이 업데이트되었습니다. [자세히 보기](../../automating/using/scheduler.md)

캠페인 및 Adobe 솔루션 통합에 대한 도움말 자료 목록을 업데이트했습니다. [](../../integrating/using/about-campaign-integrations.md)자세한 내용
...
게재를 준비하는 방법에 대한 단계별 사용 사례가 추가되었습니다. [자세히 보기](../../sending/using/preparing-the-send.md)

권한 부여 목록을 포함한 섹션이 제거되었습니다. [자세히](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf) 보기 (PDF)

SMS 자동 답글을 사용하는 방법에 대한 단계별 사용 사례가 추가되었습니다. [자세히 보기](../../channels/using/managing-incoming-sms.md#managing-stop-sms)
...
배달 오류 및 격리 정보를 업데이트했습니다. [자세히 보기](../../sending/using/monitoring-a-delivery.md)
...
보안 그룹 및 단위를 더 잘 이해하기 위해 사용 사례를 추가했습니다. [자세히 보기](../../administration/using/organizational-units.md)

동적 보고서에서 차원, 지표 및 세그먼트의 정의 및 계산 기능이 개선되었습니다. [자세히 보기](../../reporting/using/list-of-components-.md)

워크플로우가 포함된 들어오는 SMS 메시지 검색에 대한 정보가 추가되었습니다. [자세히 보기](../../administration/using/configuring-sms-channel.md)

파일 전송 활동의 내역 설정에 대한 정보가 추가되었습니다. [자세히 보기](../../automating/using/transfer-file.md)
...
모바일 앱에서'PII 데이터 수집'을 전송할 때 프로필 데이터를 만들거나 업데이트하는 방법에 대한 새로운 technote 입니다. [자세히 보기](https://helpx.adobe.com/campaign/kb/acs-updating-profile-based-on-subscription.html)

섹션이 새로운 내보내기 추적 기능에 대해 추가되었습니다. [자세히 보기](../../administration/using/auditing-export-logs.md)

곧바로 사용 가능한 패키지 내보내기에 대한 신중한 기능을 추가했습니다. [자세히 보기](../../automating/using/managing-packages.md)

외부 계정 정의 및 샘플이 업데이트되었습니다. [자세히 보기](../../administration/using/external-accounts.md)

쿼리 편집기 카테고리의 변경 사항을 반영하도록 많은 스크린샷을 업데이트했습니다.
...
기본 키에 전용 및 API에서 비즈니스 ID를 사용하는 새로운 섹션. [자세히 보기](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#primary-key)
...
Adobe Analytics와 공유되는 KPI의 세부 목록입니다. [자세히 보기](../../integrating/using/campaign-dimensions-and-metrics-in-analytics.md)

새로운 동적 보고서 비디오. [자세히 보기](../../start/using/how-to-videos.md)
...
활성 프로필에 추가된 설명서입니다. [자세히 보기](../../audiences/using/active-profiles.md)

[배달 경고](../../sending/using/receiving-alerts-when-failures-happen.md#delivery-alerting-reasons) 문서는 경고를 수신할 때 수행할 수 있는 작업에 대한 몇 가지 팁을 설명하는 문제 해결 섹션으로 업데이트되었습니다.

새 시작 안내서를 사용할 수 있습니다. Adobe Campaign에서 제공하는 데 사용할 수 있는 모범 사례 (작성 및 타깃팅에서부터 전송 및 모니터링에 이르기까지) 를 소개합니다. [자세히 보기](https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_DeliveryBestPractices.html)

추가 메시지 설명서가 향상된 사용 사례로 업데이트되었습니다. [자세히 보기](../../channels/using/follow-up-messages.md#sending-a-follow-up-message)

ACS ID에 추가된 설명서입니다. [자세히 보기](../../developing/using/configuring-the-resource-s-data-structure.md#generating-a-unique-id-for-profiles-and-custom-resources)

예제와 함께 추가된 새로운 암호화 및 해시 기능 [자세히 보기](../../automating/using/list-of-functions.md)

전송 파일 워크플로우 활동에 대한 섹션이 업데이트되었습니다. [자세히 보기](../../automating/using/transfer-file.md)
...
보고서 표시기 계산 테이블이 업데이트되었습니다. [자세히 보기](../../reporting/using/indicator-calculation.md)

보고 설명서가 4 개의 새 지표로 업데이트되었습니다. [자세히 보기](../../reporting/using/list-of-components-.md)

프로필의 고유 ID 생성에 추가된 설명서입니다. [자세히 보기](../../developing/using/configuring-the-resource-s-data-structure.md#generating-a-unique-id-for-profiles-and-custom-resources)

이중 옵트인 메커니즘은 이제 단계별 절차를 통해 문서화됩니다. [자세히 보기](../../channels/using/setting-up-a-double-opt-in-process.md)
...
수많은 스크린샷이 인터페이스가 변경되도록 업데이트되었습니다.

이제 새로운 Technote를 사용할 수 있습니다. " Adobe Mobile SDK를 모바일 앱과 통합 " [자세히 보기](https://helpx.adobe.com/campaign/kb/integrate-mobile-sdk.html)

Adobe Campaign와 People 핵심 서비스 또는 Audience Manager 통합을 위한 지침이 업데이트되었습니다. [자세히 보기](../../integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)

승인 표를 수정했습니다. [자세히 보기](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf)
...
Adobe Campaign에서 푸시 알림 및 관심 영역 데이터를 사용하는 Adobe Mobile Services 구성에 대한 새로운 전용 섹션입니다. [자세히 보기](https://helpx.adobe.com/campaign/kb/configuring-app-sdkv4.html)

푸시 알림을 설정하고 보내는 더 자세한 단계를 포함하여, 모바일 앱 구성 및 구현 섹션이 업데이트되었습니다. [자세히 보기](https://helpx.adobe.com/campaign/kb/configuring-app-sdkv4.html)

캠페인에서 이미지를 사용하여 작업하는 방법에 대한 섹션이 업데이트되었습니다. [자세히 보기](../../designing/using/setting-up-image-properties.md)
