...
![Campaign 컨트롤 패널](assets/do-not-localize/cp-icon.png) **새로운 Campaign 컨트롤 패널 릴리스**. [자세히 알아보기](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=ko){target=&quot;_blank&quot;}.
