...
2024년 6월 1일부터 Google 및 Yahoo! 발신자는 원클릭 목록 구독 취소를 준수해야 합니다. 이제 Campaign에서 이 기능을 즉시 지원합니다. [이 섹션](../../administration/using/configuring-email-channel.md#email-channel-parameters)에서 자세히 알아보십시오.
