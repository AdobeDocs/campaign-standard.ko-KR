...
## 릴리스 24.2 - 2024년 여름 릴리스 {#release-24-2-release}
...
<table>
 ...
 <tbody>
  <tr>
   <td>단계 </td>
   <td>2024년 8월 6일~13일 </td>
   <td>2025년 - 날짜 추후 결정 예정</td>
  </tr>
  <tr>
   <td>프로덕션 </td>
   <td>2024년 8월 20일~27일 </td>
   <td>2025년 - 날짜 추후 결정 예정</td>
  </tr>
 </tbody>
</table>
...
**질문: 워크플로가 계속 실행되고 게재가 전송됩니까?**

답변: 아니요. 빌드 업그레이드 중에 워크플로 서버와 MTA가 모두 중지됩니다. 즉, 워크플로가 실행되지 않고 몇 분 동안 게재가 전송되지 않습니다. 조치할 필요가 없으며 인스턴스가 업그레이드되자마자 워크플로가 다시 시작됩니다.
