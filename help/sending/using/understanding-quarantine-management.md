...
관리자는 **[!UICONTROL Administration > Channels > Quarantines > Addresses]** 메뉴에서 전체 플랫폼에 대해 격리된 전자 메일 주소의 세부 목록에 액세스할 수 있습니다.
...
새 항목을 수동으로 추가하려면 **[!UICONTROL Create]** 단추를 사용하십시오.
...
특정 조건과 일치하는 주소는 데이터베이스 정리 워크플로우에 의해 격리 목록에서 자동으로 삭제됩니다. 기술 워크플로우에 대한 자세한 내용은 [이 섹션](../../administration/using/technical-workflows.md#list-of-technical-workflows)을 참조하세요.
...
**[!UICONTROL Erroneous]** 상태의 경우 수행할 최대 다시 시도 횟수와 다시 시도 사이의 최소 지연은 이제 IP가 과거 및 현재 지정된 도메인에서 얼마나 잘 수행되고 있는지에 따라 결정됩니다.
...
주소를 수동으로 격리 해제할 수도 있습니다.  격리 목록에서 주소를 수동으로 제거하려면 격리 목록에서 주소를 제거하거나 주소를 **[!UICONTROL Valid]**(으)로 변경할 수 있습니다.

* **[!UICONTROL Administration > Channels > Quarantines > Addresses]** 목록에서 주소를 선택하고 **[!UICONTROL Delete element]**&#x200B;을(를) 선택합니다.

  ![](assets/quarantine-delete-address.png)

* 주소를 선택하고 **[!UICONTROL Status]**&#x200B;을(를) **[!UICONTROL Valid]**(으)로 변경합니다.
