...
| 소프트 바운싱 메시지 다시 시도 성공 | <ul><li>**[!UICONTROL Delivered]** 비율이 이에 따라 증가함</li><li>**[!UICONTROL Bounces + errors]** 비율이 이에 따라 감소함</li></ul> | 전송됨 |
...
| 소프트 바운싱 메시지는 Enhanced MTA에서 다시 보고됨 | <ul><li>**[!UICONTROL Delivered]** 백분율 변경 없음</li><li>**[!UICONTROL Bounces + errors]** 백분율 변경 없음</li></ul> | 전송됨 |
| 소프트 바운싱 메시지 다시 시도 성공 | <ul><li>**[!UICONTROL Delivered]** 백분율 변경 없음</li><li>**[!UICONTROL Bounces + errors]** 백분율 변경 없음</li></ul> | 전송됨 |
