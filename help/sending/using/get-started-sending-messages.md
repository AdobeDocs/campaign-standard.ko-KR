...
마지막으로, Campaign Standard에서 제공하는 전달 가능성 지침 및 도구를 활용하여 배달된 메시지 수를 개선하고 성공적인 마케팅 캠페인을 보장합니다.

## 준비 및 테스트 {#prepare-test-send}

<img src="assets/do-not-localize/icon_prepare.svg" width="60px">

Campaign Standard **메시지 준비** 기능은 타겟, 개인화 및 메시지의 유효성을 분석합니다. 이 단계 중 검색된 오류는 나중에 계속 진행하려면 먼저 수정해야 합니다.
...
Campaign 예약 기능$$을(를) 활용하여 메시지가 전송될 시기를 정의합니다. 예를 들어, 수신자의 시간대에서 전송을 조정하고, 전송 시간을 최적화하거나, 전송 날짜를 계산할 수 있습니다.
...
메시지가 준비되면 전송 및 액세스 로그와 보고서를 확인하여 전달을 **모니터링하고 캠페인의 성공을 측정할** 수 있습니다. 또한 Adobe Campaign은 전달 성공이나 실패를 추적할 수 있는 이메일 경고 시스템과 격리 관리 기능을 제공합니다.
...
Campaign Standard는 배달된 메시지의 수를 향상시키는 데 도움이 되는 몇 가지 **배달** 도구를 제공합니다. 전달 시간 보고서, 전송 시간 최적화, 메시지 미리 보기, 이메일 렌더링, 격리 관리 등
