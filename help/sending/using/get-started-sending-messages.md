...
Campaign Standard **메시지 준비**&#x200B;에서는 대상, 개인화 및 메시지의 유효성을 분석합니다. 이 단계에서 감지된 오류를 수정한 후에 계속 진행해야 합니다.
...
Campaign Standard은 배달된 메시지 수를 개선하는 데 도움이 되는 몇 가지 **게재 기능 도구**&#x200B;를 제공합니다. 게재 처리량 보고서, 전송 시간 최적화, 메시지 미리 보기, 이메일 렌더링, 격리 관리 등.
...
이 비디오는 Campaign Standard에서 테스트 이메일을 보내고, 준비하고 이메일 게재를 보내는 방법을 보여 줍니다.
