...
* **각 시간** 전자 메일 렌더링 보고서가 생성되면 메시징 클라이언트당 하나의 토큰이 제외됩니다. Outlook 2000 렌더링을 위한 토큰 1개, Outlook 렌더링을 위한 토큰, Apple Mail 렌더링을 위한 토큰.

* **동일한 게재의 경우**&#x200B;로 지정하는 경우 이메일 렌더링을 다시 생성하면 사용 가능한 토큰 수가 생성된 렌더링 수로 다시 감소합니다.
