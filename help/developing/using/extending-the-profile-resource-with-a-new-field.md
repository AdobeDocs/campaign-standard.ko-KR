...
여기에서는 이 필드를 입력하지 않은 워크플로 프로필을 타겟팅하려고 합니다. 이들은 개인화된 뉴스레터 및 오퍼를 수신할 수 있도록 프로필을 업데이트하라는 이메일을 받게 됩니다. 그러고 나면 각 프로필은 선택한 관심사에 따라 개인화된 뉴스레터를 수신하게 됩니다.
...
이제 랜딩 페이지를 사용할 수 있습니다. 선택한 관심사에 따라 특별 오퍼를 보내는 워크플로를 만들어 프로필을 업데이트할 수 있습니다.
...
1. **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다. 이제 이메일이 준비되었습니다. 워크플로로 돌아올 수 있습니다.
