...
* 문자열 필드의 길이는 항상 열을 사용하여 정의해야 합니다. 기본적으로 Adobe Campaign의 최대 길이는 255자이지만, 크기가 더 짧은 길이를 초과하지 않도록 이미 알고 있는 경우에는 필드를 더 짧게 유지하는 것이 좋습니다.
